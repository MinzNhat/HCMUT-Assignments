...
const Navbar = ({ }: Props) => {
  ...
  return (
    <nav className="sticky top-4 z-40 flex flex-row gap-4 flex-wrap items-center justify-between rounded-xl bg-white/10 p-2 backdrop-blur-xl dark:bg-[#0b14374d]">
          ...
          <div className="flex w-[360px] flex-col gap-3 rounded-[20px] bg-white p-4 shadow-xl shadow-shadow-500 dark:!bg-navy-700 dark:text-white dark:shadow-none sm:w-[460px]">
            ...
            <Button className="flex w-full items-center">
              ...
              <div className="ml-2 flex h-full w-full flex-col justify-center rounded-lg px-1 text-sm pl-2">
                ...
                <p className="font-base text-left text-xs text-gray-900 dark:text-white w-full">

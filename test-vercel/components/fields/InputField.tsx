  ...
  return (
    <div className={`${extra}`}>
      ...
      <input
        ...
        className={`mt-2 flex h-12 w-full items-center justify-center rounded-xl border ${className ? className : "bg-white/0"} p-3 text-sm outline-none duration-300 ${disabled === true
